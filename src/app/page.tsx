...
function PostCard(
  { 
    ...
    title = "This is a really long title to see how the word wrap works", 
  ...
  return (
    <div className="bg-gray-800 h-48 rounded-lg p-6 relative flex flex-col gap-4 overflow-clip group hover:-translate-y-[2px] cursor-pointer transition-transform duration-75">
      <img src={imageUrl} className="absolute top-0 left-0 blur-sm brightness-[0.4] group-hover:brightness-[0.2]" />
